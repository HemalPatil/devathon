			...
			<div class="navbar-fixed">
				<nav class="cyan">
					<div class="nav-wrapper">
						<ul class="center">
							<li><h1 class="logo-wrapper"><a href="<?php echo base_url('/test'); ?>" class="brand-logo darken-1">DEVATHON</a></h1></li>
						</ul>
					</div>
				</nav>
			</div>
					...
					<ul id="slide-out" class="side-nav fixed leftside-navigation">
						<li class="bold">
							<a href="<?php echo base_url('/test')?>" class="waves-effect waves-cyan">
								<i class="mdi-action-home"></i>Hello
							</a>
						</li>
						<li class="bold">
							<a href="<?php echo base_url('/test')?>" class="waves-effect waves-cyan">
								<i class="mdi-action-home"></i>World
							</a>
						</li>
					</ul>
				</aside>
				<section>
					<p style="text-align: center">MODIFY CONFERENCE</p>
					<form action= method=>
						<div class="container" align="center" style="margin-left:10%; margin-right:10%; width:80%">
							<div class="input-field col l12 m12 s12">
								<input type="text" name="conference_title" id="conference_title">
								<label for="conference_title">Title</label>
							</div>
							<div class="input-field col l12 m12 s12">
								<input type="text" name="conference_url" id="conference_url">
							...
							<div class="input-field col l6 m6 s6">
								<input type="date" class="datepicker" name="conference_start_date" id="conference_start_date">
								<label for="conference_start_date">Start Date</label>
							</div>
							<div class="input-field col l6 m6 s6">
								<input type="date" class="datepicker" name="conference_end_date" id="conference_end_date">
