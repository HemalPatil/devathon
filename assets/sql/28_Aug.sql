...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2016 at 11:07 PM
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'eTx/Wo1Q2RP4vWnZkOHfE.', 1268889823, 1472327974, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
(6, '::1', NULL, '$2y$08$DZOoApqgw7I5bBFHeCIz3ex9Y92pzOuW0jRlb1UBc2IQz2DgfkZ8.', NULL, 'sree@nath.com', NULL, NULL, NULL, NULL, 1472321786, NULL, 1, 'Sreerag', 'Sreenath', NULL, NULL);
...
--
ALTER TABLE `conferences`
  MODIFY `conference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
